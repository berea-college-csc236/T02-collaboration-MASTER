...
int main() {
    ...
    for (int i = 0; i < ducknum; i++) { 
        cout << "                __     " << endl; // TODO: student 1 may change this line and may add additional lines of art above
        cout << "              <(o )___-" << endl; // student 3(1) may change this line and add additional lines between this line and the blotto of the duck
